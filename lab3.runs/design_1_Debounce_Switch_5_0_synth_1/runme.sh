...
HD_PWD='/home/sims0702/DDC_project-main/lab3.runs/design_1_Debounce_Switch_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Debounce_Switch_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Debounce_Switch_5_0.tcl
